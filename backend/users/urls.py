...
from .views import RegisterUserView, FarmerProfileView, BuyerProfileView, InspectorProfileView
...
urlpatterns = [
    ...
    path('inspector/profile', InspectorProfileView.as_view(), name = 'inspector_profile'), # endpoint for inspector profile
]